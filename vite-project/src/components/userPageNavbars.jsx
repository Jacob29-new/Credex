...
import credexLogo from "../assets/credex2.png";
        ...
        <>
            <div className={`relative hidden xl:flex lg:flex md:flex flex-col h-full left-0 top-0 bg-[hsl(30,3.33%,11.76%)] items-center transition-all duration-300  ${isOpen ? "w-64" : "w-12 flex flex-col items-center"} shadow-right-4xl`}>
                <div className="items-center flex h-10 w-9/10 mt-3">
                    ...
                    <p className={`ml-auto text-lg uppercase text-sm font-bold text-gray-200 tracking-wide transition-all duration-1000 ${isOpen ? "opacity-100" : "opacity-0 hidden"}`}>credex</p>
                </div>
                <div className={`items-center flex flex-row h-10 w-9/10 mt-10 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/home" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                ...
                <div className={`items-center flex flex-row h-10 w-9/10 mt-2 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/tasks" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                ...
                <div className={`items-center flex flex-row h-10 w-9/10 mt-2 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/credits" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                ...
                <div className={`items-center flex flex-row h-10 w-9/10 mt-2 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/messages" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                ...
                <div className={`items-center relative flex flex-row h-10 w-9/10 mt-2 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/notifications" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                ...
                <div className={`items-center flex flex-row h-10 w-9/10 mt-2 transition-all duration-100 rounded-xl hover:bg-black ${window.location.pathname === "/user/settings" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
...
function SmallScreenNavbar() {
    return (
        <div className="flex xl:hidden lg:hidden md:hidden w-full fixed bottom-0 bg-[hsl(30,3.33%,11.76%)] h-13 items-center justify-center">
            <div className={`flex items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/home" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                <img src={home} className="h-7 w-7 " />
            </div>
            <div className={`flex items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/tasks" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                <img src={tasks} className="h-7 w-7  " />
            </div>
            <div className={`flex items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/credits" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                <img src={credits} className="h-7 w-7  " />
            </div>
            <div className={`flex items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/chat" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                <img src={chat} className="h-7 w-7  " />
            </div>
            <div className={`flex relative items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/notifications" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
                <img src={notifications} className="h-7 w-7  " />
                {/* <div className="absolute top-0 right-0 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center">1</div> */}
            </div>
            <div className={`flex items-center justify-center h-10 w-10 hover:cursor-pointer hover:bg-black rounded-full mr-5 ${window.location.pathname === "/user/settings" ? "bg-gray-700 hover:bg-gray-700" : ""}`}>
